          ...
          <div class="row">
              ...
              <div class="well profile">
                <div class="col-sm-12 row">
                  ...
                  <div class="col-xs-12 col-sm-12 emphasis">
                    ...
                    <p>Legend:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="{{asset('assets/img/alreadybox.png')}}"id="borderimg"/> already Assigned to other&nbsp;
                    <img src="{{asset('assets/img/ownbox.png')}}"id="borderimg"/> its own
                  </p>
                  </div>       
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                ...
                <form class="d-flex justify-content-end" method="get" action="{{route('filter-orders-to-worker')}}" >
                    {{csrf_field()}}
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr style="@if(!empty($value->task) && $value->task->worker_id == $workerDetail->id) background-color:#8FB8DE !important @elseif(!empty($value->task)) background-color:#9A94BC !important  @endif ">
                          ...
                          <td>@if(empty($value->task->worker)) -- @else {{$value->task->worker->name}} @endif</td>
                          ...
                          <td><div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                  @if(!empty($value->task)) <a class="dropdown-item viewOrderDetails" id="viewOrderDetails" data-toggle="modal" data-target="#OrderDetailModal" data-order_id="{{$value->id}}"><i class="material-icons">visibility</i>View Order Details</a> 
                                  @else

                                  <form action="{{route('assign-order-toworker')}}" method="post">
                                  {{csrf_field()}}
                                  <input type="hidden" name="order_id" value="{{$value->id}}">
                                  <input type="hidden" name="worker_id" value="{{$workerDetail->id}}">
                                  <button type="submit" class=" dropdown-item"><i class="material-icons">touch_app</i>Assign</button>
